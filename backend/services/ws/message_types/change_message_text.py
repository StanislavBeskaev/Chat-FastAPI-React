...
class ChangeMessageTextMessage(BaseChatWSMessage):
    ...
    def __init__(
        self, chat_id: str, message_id: str, message_text: str, change_time: str, db_facade: DBFacadeInterface
    ):
        self._change_message_text_data = models.ChangeMessageTextData(
            text=message_text, chat_id=chat_id, message_id=message_id, change_time=change_time
        )
